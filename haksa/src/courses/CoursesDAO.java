...
public class CoursesDAO {
	...
	public JSONObject list(SqlVO vo) {
		...
		try {
			...
			System.out.println("강좌 목록 출력 error: " + e.toString());
		}
		return jObject;
	}
	...
	public ArrayList<CoursesVO> listAll() {
		...
		try {
			...
			System.out.println("모든 강좌 목록 error: " + e.toString());
		}
		return list;
	}
	...
	public int checkCode(String lcode) {
		...
		try {
			...
			System.out.println("강좌 코드 체크 error: " + e.toString());
		}
		return count;
	}
	...
	public void insert(CoursesVO vo) {
		try {
			...
			System.out.println("강좌 등록 error: " + e.toString());
		}
	}
	...
	public CoursesVO read(String lcode) {
		...
		try {
			...
			System.out.println("강좌 정보 읽기 error: " + e.toString());
		}
		return vo;
	}
	...
	public int delete(String lcode) {
		...
		try {
			...
			System.out.println("강좌 삭제 error: " + e.toString());
		}
		return count;
	}
}
